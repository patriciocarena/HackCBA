...
| B6 | One final number | Juan Bautista | B4 | - | 0.5 | Sat 18:00 → 18:30 | No amount leaves the engine that is not the final number: the list is net, so totalOf grosses it up once at the end, with a test |
