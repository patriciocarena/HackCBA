# Lessons, D5 adversarial suite (DAN-22)

A sibling lane already owns `tasks/lessons-dan-22.md`, so this lane's file is named after the
lane instead of the ticket.
